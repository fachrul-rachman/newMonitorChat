...
- Implementasi: Chat Viewer akan menggunakan polling via endpoint `/monitorchat/api/chat` setiap beberapa detik (tanpa WebSocket) untuk memuat pesan sesi terbaru.
